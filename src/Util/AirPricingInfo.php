...
class AirPricingInfo
{
    ...
    /**
     * @var anonymous545 $FareCalculationInd
     */
     ...
     * @param anonymous544 $PricingType
     * @param string $TrueLastDateToTicket
     * @param anonymous545 $FareCalculationInd
    ...
    /**
     * @param FareInfo $FareInfo
     * @return \FilippoToso\Travelport\Util\AirPricingInfo
     */
