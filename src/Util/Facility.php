...
class Facility
{
    ...
    /**
     * @var anonymous584 $ServiceSubCode
     */
    ...
    /**
     * @var anonymous585 $IssuanceReason
     */
     ...
     * @param boolean $Paid
     * @param anonymous584 $ServiceSubCode
     * @param typeSSRCode $SSRCode
     * @param anonymous585 $IssuanceReason
    ...
    /**
     * @param Characteristic $Characteristic
     * @return \FilippoToso\Travelport\Util\Facility
     */
