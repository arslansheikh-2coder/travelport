...
class typeBaseAirSegment extends Segment
{
    ...
    /**
     * @var anonymous980 $NumberInParty
     */
    public $NumberInParty = null;

    /**
     * @var anonymous981 $RailCoachNumber
     */
     ...
     * @param anonymous980 $NumberInParty
     * @param anonymous981 $RailCoachNumber
    ...
    /**
     * @param SponsoredFltInfo $SponsoredFltInfo
     * @return \FilippoToso\Travelport\Util\typeBaseAirSegment
     */
