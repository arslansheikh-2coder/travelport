...
class Bindings
{
    public static $bindings = [
		...
		Air\FlightDetailsReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/FlightDetailsBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'FlightService',
		],
		Air\LowFareSearchReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirLowFareSearchBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\LowFareSearchAsynchReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirLowFareSearchAsynchBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\RetrieveLowFareSearchReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirRetrieveLowFareSearchBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\ScheduleSearchReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirScheduleSearchBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AvailabilitySearchReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirAvailabilitySearchBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirRepriceReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirRepriceSearchBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirPriceReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirPriceBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirTicketingReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirTicketingBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirExchangeQuoteReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirExchangeQuoteBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirExchangeReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirExchangeProcessBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirExchangeTicketingReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirExchangeTicketingBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirRefundReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirRefundTicketBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirRefundQuoteReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirRefundQuoteBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirFareDisplayReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirFareDisplayBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirFareRulesReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirFareRulesBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\SeatMapReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/SeatMapBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirVoidDocumentReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirVoidDocumentBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirRetrieveDocumentReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirRetrieveDocumentBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirMerchandisingOfferAvailabilityReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirMerchandisingOfferAvailabilityBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirUpsellSearchReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirUpsellSearchBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\FlightInformationReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/FlightInfoBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'FlightService',
		],
		Air\FlightTimeTableReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/FlightTimeTableBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\EMDIssuanceReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/EMDIssuanceBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirMerchandisingDetailsReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirMerchandisingDetailsBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirExchangeEligibilityReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirExchangeEligibilityBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\EMDRetrieveReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/EMDRetrieveBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Air\AirExchangeMultiQuoteReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/air_v49_0/AirExchangeMultiQuoteBinding.wsdl',
			'service' => Air\AirService::class,
			'url' => 'AirService',
		],
		Rail\RailAvailabilitySearchReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/rail_v49_0/RailAvailabilitySearchBinding.wsdl',
			'service' => Rail\RailService::class,
			'url' => 'RailService',
		],
		Rail\RailRefundQuoteReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/rail_v49_0/RailRefundQuoteBinding.wsdl',
			'service' => Rail\RailService::class,
			'url' => 'RailService',
		],
		Rail\RailRefundReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/rail_v49_0/RailRefundBinding.wsdl',
			'service' => Rail\RailService::class,
			'url' => 'RailService',
		],
		Rail\RailExchangeQuoteReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/rail_v49_0/RailExchangeQuoteBinding.wsdl',
			'service' => Rail\RailService::class,
			'url' => 'RailService',
		],
		Rail\RailExchangeReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/rail_v49_0/RailExchangeCreateReservationBinding.wsdl',
			'service' => Rail\RailService::class,
			'url' => 'RailService',
		],
		Rail\RailSeatMapReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/rail_v49_0/RailSeatMapBinding.wsdl',
			'service' => Rail\RailService::class,
			'url' => 'RailService',
		],
		Hotel\HotelSearchAvailabilityReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/hotel_v49_0/HotelSearchServiceBinding.wsdl',
			'service' => Hotel\HotelService::class,
			'url' => 'HotelService',
		],
		Hotel\HotelSearchAvailabilityAsynchReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/hotel_v49_0/HotelSearchAvailabilityAsynchServiceBinding.wsdl',
			'service' => Hotel\HotelService::class,
			'url' => 'HotelService',
		],
		Hotel\HotelMediaLinksReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/hotel_v49_0/HotelMediaLinksServiceBinding.wsdl',
			'service' => Hotel\HotelService::class,
			'url' => 'HotelService',
		],
		Hotel\HotelDetailsReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/hotel_v49_0/HotelDetailsServiceBinding.wsdl',
			'service' => Hotel\HotelService::class,
			'url' => 'HotelService',
		],
		Hotel\HotelRetrieveReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/hotel_v49_0/HotelRetrieveServiceBinding.wsdl',
			'service' => Hotel\HotelService::class,
			'url' => 'HotelService',
		],
		Hotel\HotelRulesReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/hotel_v49_0/HotelRulesServiceBinding.wsdl',
			'service' => Hotel\HotelService::class,
			'url' => 'HotelService',
		],
		Hotel\HotelUpsellDetailsReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/hotel_v49_0/HotelUpsellSearchServiceBinding.wsdl',
			'service' => Hotel\HotelService::class,
			'url' => 'HotelService',
		],
		Hotel\HotelKeywordReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/hotel_v49_0/HotelKeywordsServiceBinding.wsdl',
			'service' => Hotel\HotelService::class,
			'url' => 'HotelService',
		],
		Hotel\HotelSuperShopperReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/hotel_v49_0/HotelSuperShopperServiceBinding.wsdl',
			'service' => Hotel\HotelService::class,
			'url' => 'HotelService',
		],
		Hotel\RetrieveHotelSearchAvailabilityReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/hotel_v49_0/RetrieveHotelSearchAvailabilityServiceBinding.wsdl',
			'service' => Hotel\HotelService::class,
			'url' => 'HotelService',
		],
		Vehicle\VehicleSearchAvailabilityReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/vehicle_v49_0/VehicleSearchServiceBinding.wsdl',
			'service' => Vehicle\VehicleService::class,
			'url' => 'VehicleService',
		],
		Vehicle\VehicleRetrieveReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/vehicle_v49_0/VehicleRetrieveServiceBinding.wsdl',
			'service' => Vehicle\VehicleService::class,
			'url' => 'VehicleService',
		],
		Vehicle\VehicleLocationDetailReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/vehicle_v49_0/VehicleLocationDetailBinding.wsdl',
			'service' => Vehicle\VehicleService::class,
			'url' => 'VehicleService',
		],
		Vehicle\VehicleRulesReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/vehicle_v49_0/VehicleRulesServiceBinding.wsdl',
			'service' => Vehicle\VehicleService::class,
			'url' => 'VehicleService',
		],
		Vehicle\VehicleKeywordReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/vehicle_v49_0/VehicleKeywordsServiceBinding.wsdl',
			'service' => Vehicle\VehicleService::class,
			'url' => 'VehicleService',
		],
		Vehicle\VehicleLocationReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/vehicle_v49_0/VehicleLocationServiceBinding.wsdl',
			'service' => Vehicle\VehicleService::class,
			'url' => 'VehicleService',
		],
		Vehicle\VehicleUpsellSearchAvailabilityReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/vehicle_v49_0/VehicleUpsellSearchServiceBinding.wsdl',
			'service' => Vehicle\VehicleService::class,
			'url' => 'VehicleService',
		],
		Vehicle\VehicleMediaLinksReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/vehicle_v49_0/VehicleMediaLinksServiceBinding.wsdl',
			'service' => Vehicle\VehicleService::class,
			'url' => 'VehicleService',
		],
		...
		GDSQueue\GdsQueueCountReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/gdsQueue_v49_0/GdsQueueCountServiceBinding.wsdl',
			'service' => GDSQueue\GDSQueueService::class,
			'url' => 'GdsQueueService',
		],
		GDSQueue\GdsQueueListReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/gdsQueue_v49_0/GdsQueueListServiceBinding.wsdl',
			'service' => GDSQueue\GDSQueueService::class,
			'url' => 'GdsQueueService',
		],
		GDSQueue\GdsQueuePlaceReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/gdsQueue_v49_0/GdsQueuePlaceServiceBinding.wsdl',
			'service' => GDSQueue\GDSQueueService::class,
			'url' => 'GdsQueueService',
		],
		GDSQueue\GdsEnterQueueReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/gdsQueue_v49_0/GdsEnterQueueServiceBinding.wsdl',
			'service' => GDSQueue\GDSQueueService::class,
			'url' => 'GdsQueueService',
		],
		GDSQueue\GdsExitQueueReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/gdsQueue_v49_0/GdsExitQueueServiceBinding.wsdl',
			'service' => GDSQueue\GDSQueueService::class,
			'url' => 'GdsQueueService',
		],
		GDSQueue\GdsNextOnQueueReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/gdsQueue_v49_0/GdsNextOnQueueServiceBinding.wsdl',
			'service' => GDSQueue\GDSQueueService::class,
			'url' => 'GdsQueueService',
		],
		GDSQueue\GdsQueueRemoveReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/gdsQueue_v49_0/GdsQueueRemoveServiceBinding.wsdl',
			'service' => GDSQueue\GDSQueueService::class,
			'url' => 'GdsQueueService',
		],
		GDSQueue\GdsQueueAgentListReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/gdsQueue_v49_0/GdsQueueAgentListServiceBinding.wsdl',
			'service' => GDSQueue\GDSQueueService::class,
		...
		UniversalRecord\UniversalRecordRetrieveReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/UniversalRecordRetrieveServiceBinding.wsdl',
		...
		UniversalRecord\UniversalRecordHistorySearchReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/UniversalRecordHistorySearchServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'UniversalRecordHistorySearchService',
		],
		UniversalRecord\UniversalRecordSearchReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/UniversalRecordSearchServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'UniversalRecordService',
		],
		UniversalRecord\AckScheduleChangeReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/AckScheduleChangeServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'ScheduleChangeService',
		],
		UniversalRecord\UniversalRecordImportReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/UniversalRecordImportServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'UniversalRecordService',
		],
		UniversalRecord\UniversalRecordModifyReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/UniversalRecordModifyServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'UniversalRecordService',
		],
		UniversalRecord\UniversalRecordCancelReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/UniversalRecordCancelServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'UniversalRecordService',
		],
		UniversalRecord\ProviderReservationDisplayDetailsReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/ProviderReservationDisplayServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'ProviderReservationDisplayService',
		],
		UniversalRecord\ProviderReservationDivideReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/ProviderReservationDivideServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'UniversalRecordService',
		],
		UniversalRecord\SavedTripCreateReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/SavedTripCreateServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'SavedTripCreateService',
		],
		UniversalRecord\SavedTripModifyReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/SavedTripModifyServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'SavedTripModifyService',
		],
		UniversalRecord\SavedTripRetrieveReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/SavedTripRetrieveServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'SavedTripRetrieveService',
		],
		UniversalRecord\SavedTripDeleteReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/SavedTripDeleteServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'SavedTripDeleteService',
		],
		UniversalRecord\SavedTripSearchReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/SavedTripSearchServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'SavedTripSearchService',
		],
		UniversalRecord\VehicleCreateReservationReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/VehicleReservationServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'VehicleService',
		],
		UniversalRecord\VehicleCancelReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/VehicleCancelServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'VehicleService',
		],
		UniversalRecord\HotelCreateReservationReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/HotelReservationServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'HotelService',
		],
		UniversalRecord\HotelCancelReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/HotelCancelServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'HotelService',
		],
		UniversalRecord\RailCreateReservationReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/RailCreateReservationBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'RailService',
		],
		UniversalRecord\AirCreateReservationReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/AirCreateReservationBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'AirService',
		],
		UniversalRecord\AirCancelReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/AirCancelBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'AirService',
		],
		UniversalRecord\AirMerchandisingFulfillmentReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/AirMerchandisingFulfillmentBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'AirService',
		],
		UniversalRecord\PassiveCreateReservationReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/PassiveReservationServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'PassiveService',
		],
		UniversalRecord\PassiveCancelReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/universal_v49_0/PassiveCancelServiceBinding.wsdl',
			'service' => UniversalRecord\UniversalRecordService::class,
			'url' => 'PassiveService',
		],
		...
		Util\CreditCardAuthReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/UtilCreditCardAuthBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'CreditCardAuthorizationService',
		],
		Util\CreateAgencyFeeMcoReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/McoCreateAgencyFeeBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'UtilService',
		],
		Util\McoVoidReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/McoVoidBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'UtilService',
		],
		Util\MirReportRetrieveReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/ReportRetrieveBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'UtilService',
		],
		Util\McoSearchReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/McoSearchBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'UtilService',
		],
		Util\MctCountReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/MctCountBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'UtilService',
		],
		Util\MctLookupReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/MctLookupBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'UtilService',
		],
		Util\CalculateTaxReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/CalculateTaxBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'UtilService',
		],
		Util\ContentProviderRetrieveReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/ContentProviderRetrieveBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'UtilService',
		],
		Util\CurrencyConversionReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/UtilCurrencyConversionBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'CurrencyConversionService',
		],
		Util\ReferenceDataRetrieveReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/ReferenceDataRetrieveBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'UtilService',
		],
		Util\ReferenceDataSearchReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/ReferenceDataLookupBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'ReferenceDataLookupService',
		],
		Util\ReferenceDataUpdateReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/ReferenceDataUpdateBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'UtilService',
		],
		Util\UpsellAdminReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/UpsellAdminBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'UpsellAdminService',
		],
		Util\BrandedFareAdminReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/BrandedFareAdminBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'BrandedFareService',
		],
		Util\UpsellSearchReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/UpsellAdminSearchBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'UpsellAdminSearchService',
		],
		Util\BrandedFareSearchReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/BrandedFareSearchBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'BrandedFareService',
		],
		Util\AgencyServiceFeeCreateReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/AgencyCreateServiceFeeBinding.wsdl',
			'service' => Util\UtilService::class,
			'url' => 'AgencyFeeService',
		],
		Util\FindEmployeesOnFlightReq::class => [
			'wsdl' => __DIR__ . '/Wsdls/util_v49_0/FindEmployeesOnFlightServiceBinding.wsdl',
			'service' => Util\UtilService::class,
