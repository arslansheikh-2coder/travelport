...
class OTHType
{
    ...
    /**
     * @param boolean $Cat0
     * @return \FilippoToso\Travelport\UniversalRecord\OTHType
     */
     ...
     * @return date
     */
    public function getRestrictiveDt()
    {
     ...
     * @return float
     */
    public function getSurchargeAmt()
    {
     ...
     * @return boolean
     */
    public function getMissingRules()
    {
