...
class AirPricingInfo
{
    ...
    /**
     * @var anonymous548 $FareCalculationInd
     */
     ...
     * @param anonymous547 $PricingType
     * @param string $TrueLastDateToTicket
     * @param anonymous548 $FareCalculationInd
