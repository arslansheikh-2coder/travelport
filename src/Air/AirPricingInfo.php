...
class AirPricingInfo
{
    ...
    /**
     * @var anonymous614 $FareCalculationInd
     */
     ...
     * @param anonymous613 $PricingType
     * @param string $TrueLastDateToTicket
     * @param anonymous614 $FareCalculationInd
    ...
    /**
     * @param FareInfo $FareInfo
     * @return \FilippoToso\Travelport\Air\AirPricingInfo
     */
